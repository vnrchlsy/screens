...
function listAnimal(paws, opts = {}) {
  const tier1 = !!opts.tier1;
  let s = `<rect width="${SW}" height="${SH}" fill="${BG}"/>` + topbar("List an animal");
...
function reportStraySent(paws) {
  ...
  s += v2squircle(270, 250, 116, "url(#v2hero)", 36);
  s += `<polyline points="238,250 262,274 306,226" fill="none" stroke="${WHITE}" stroke-width="10" stroke-linecap="round" stroke-linejoin="round"/>`;
